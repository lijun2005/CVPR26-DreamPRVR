...
we propose *DreamPRVR*, which adopts a coarse-to-fine representation learning paradigm. 
...
(iii) The registers are then adaptively fused  with video tokens through register-augmented Gaussian attention blocks, enabling context-aware feature learning.
